...
#ifndef ALIER_SWIFT_H
#define ALIER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="alier",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS_NAMED("DefaultNotification")
...
SWIFT_CLASS("_TtC5alier22GetResourceCoordinator")
@interface GetResourceCoordinator : NSObject <MPMediaPickerControllerDelegate, UIDocumentPickerDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate>
/// For Audio*
...
SWIFT_CLASS("_TtC5alier23LifeCycle_UIApplication")
@interface LifeCycle_UIApplication : UIResponder <UIApplicationDelegate>
...
SWIFT_CLASS("_TtC5alier17LifeCycle_UIScene")
@interface LifeCycle_UIScene : UIResponder <UIWindowSceneDelegate>
...
SWIFT_CLASS("_TtC5alier12_Coordinator")
@interface _Coordinator : NSObject <UIScrollViewDelegate, WKNavigationDelegate, WKURLSchemeHandler>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC5alier14_FileOperation")
@interface _FileOperation : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC5alier24_NativeFunctionInterface")
@interface _NativeFunctionInterface : NSObject <WKScriptMessageHandler, WKUIDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC5alier21_ScriptMessageHandler")
@interface _ScriptMessageHandler : NSObject <WKScriptMessageHandler>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
/// JSと双方向通信を行う関数
- (void)userContentController:(WKUserContentController * _Nonnull)userContentController didReceiveScriptMessage:(WKScriptMessage * _Nonnull)message;
@end
